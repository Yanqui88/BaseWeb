...
export default function Sidebar({ onCloseMobile, userName, userEmail }: { onCloseMobile?: () => void, userName?: string, userEmail?: string }) {
  ...
  const email = userEmail || 'admin@acme.com';
